...
export interface ApiBannerBanner extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide banner displayed below the navbar';
    displayName: 'Banner';
    pluralName: 'banners';
    singularName: 'banner';
  };
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts for the platform';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Comments for responsa questions';
    displayName: 'Comment';
    pluralName: 'comments';
...
export interface ApiEmailIssueCategoryEmailIssueCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'email_issue_categories';
  info: {
    description: 'Categories for contact form issues to help with email filtering';
    displayName: 'Email Issue Category';
    pluralName: 'email-issue-categories';
...
export interface ApiPlaylistPlaylist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    imageUrl300x400: Schema.Attribute.String;
    imageUrlStandard: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiResponsaResponsa extends Struct.CollectionTypeSchema {
  collectionName: 'responsas';
  info: {
    description: 'Questions and answers section';
    displayName: 'Responsa';
    pluralName: 'responsas';
    singularName: 'responsa';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::email-issue-category.email-issue-category': ApiEmailIssueCategoryEmailIssueCategory;
