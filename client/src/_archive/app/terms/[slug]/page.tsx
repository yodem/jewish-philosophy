    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <header className="mb-8 text-center">
          ...
          {/* Metadata */}
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground dark:text-muted-foreground mb-6">
            {term.author && (
        ...
        <div className="prose prose-lg max-w-none text-right mx-auto">
          <div className="bg-gradient-to-br from-white via-white to-cyan-100 dark:from-gray-900 dark:via-gray-900 dark:to-cyan-200/20 rounded-xl p-8 shadow-sm border">
            <p className="text-lg leading-relaxed text-foreground dark:text-gray-200 whitespace-pre-wrap text-justify">
              {term.description}
            </p>
          </div>
        </div>
