            ...
            <div className="divide-y divide-border">
              {isLoading ? (
                ...
                responsas.map((responsa) => (
                  <div
                    key={responsa.id}
                    className="grid grid-cols-1 md:grid-cols-12 gap-4 px-6 md:px-8 py-6 hover:bg-accent/10 transition-colors cursor-pointer group"
                  ...
                  >
                    ...
                    <div className="col-span-1 md:col-span-1 flex md:flex-col items-center justify-center gap-1 text-muted-foreground/70">
                    ...
                    <div className="col-span-1 md:col-span-1 flex items-center md:justify-end text-muted-foreground/70 text-sm">
          ...
          <div className="mt-12 bg-primary rounded-3xl p-8 relative overflow-hidden shadow-lg">
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="text-center md:text-right">
                ...
                <p className="text-primary-foreground/70">הרבנים והמומחים שלנו כאן כדי לעזור בכל נושא תורני או פילוסופי.</p>
              </div>
              <QuestionFormWrapper />
            </div>
          </div>
