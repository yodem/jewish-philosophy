...
export const metadata: Metadata = generateMetadata({
  ...
  url: "/blog",
  type: "website",
  keywords: "בלוג פילוסופיה דתית, פילוסופיה דתית, הרמב\"ם, מאמרי פילוסופיה, מושגים בפילוסופיה דתית, מבוא לפילוסופיה דתית, מורה נבוכים, משנה תורה, כוזרי, שלום צדיק, יהדות רציונלית, פילוסופיה דתית מתונה",
});
