...
import { WritingViewTracker, WritingButtonTracker } from "@/components/shared/WritingTracker";
...
export default async function WritingPage({ params }: WritingPageProps) {
  ...
  const defaultButtonText = isBook ? 'צפו בספר' : 'קראו את המאמר';
            ...
            <div className="text-center mt-8">
              ...
              >
                ...
                >
                  ...
                  >
                    {pdfUrl
                      ? (isBook ? 'צפו בספר (PDF)' : 'קראו את המאמר (PDF)')
