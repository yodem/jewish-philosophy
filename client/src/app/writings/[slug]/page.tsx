...
export default async function WritingPage({ params }: WritingPageProps) {
  ...
  const placeholderImage = isBook ? '/placeholder-book.jpg' : '/placeholder-article.jpg';
  const buttonClass = isBook 
        ...
        {writing.linkToWriting?.href && (
          <div className="text-center mt-8">
            <Link
              ...
              className={`inline-flex items-center gap-2 ${buttonClass} text-white px-6 py-3 rounded-lg font-semibold transition-colors`}
            >
