...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    description: 'פלטפורמה מובילה ללימוד פילוסופיה דתית מקוונת - שיעורי וידאו, הרמב״ם, ואגדה עם שלום צדיק. תכנים איכותיים בפילוסופיה דתית, יהדות רציונלית, ביקורת החילון.',
    start_url: '/',
    display: 'standalone',
